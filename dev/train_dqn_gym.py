...
from episodes import NewFCLSTMStateQFunction
from dqn import NewDQN
...
def main():
    ...
    if isinstance(action_space, spaces.Box):
        ...
        q_func = NewFCLSTMStateQFunction(
            obs_size, n_actions,
            n_hidden_channels=args.n_hidden_channels,
            n_hidden_layers=args.n_hidden_layers)
    ...
    agent = NewDQN(q_func, opt, rbuf, gpu=args.gpu, gamma=args.gamma,
